...
def create_prediction_dataset(file_paths, params):
    ...
    for file_path in tqdm(file_paths, desc="Loading and Processing Files"):
        try:
            ...
            new_column_names = {
                original_columns[0]: 'Time',
                original_columns[1]: 'Acc_X',
                original_columns[2]: 'Acc_Y',
                original_columns[3]: 'Acc_Z',
                original_columns[4]: 'Gyr_X',
                original_columns[5]: 'Gyr_Y',
                original_columns[6]: 'Gyr_Z',
                original_columns[7]: 'FoG_Label'
            }
